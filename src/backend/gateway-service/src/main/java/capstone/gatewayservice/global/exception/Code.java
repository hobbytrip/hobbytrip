...
public enum Code {
    ...
    INTERNAL_ERROR(10010, HttpStatus.INTERNAL_SERVER_ERROR, "Internal error"),
    DATA_ACCESS_ERROR(10011, HttpStatus.INTERNAL_SERVER_ERROR, "Data access error"),

    UNAUTHORIZED(10020, HttpStatus.UNAUTHORIZED, "User unauthorized");

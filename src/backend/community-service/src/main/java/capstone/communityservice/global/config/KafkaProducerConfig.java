...
//
//    @Bean
//    public ProducerFactory<String, CommunityMessageDto> communityChatProducerFactory() {
//        return new DefaultKafkaProducerFactory<>(producerConfig());
//    }
//
//    @Bean
//    public KafkaTemplate<String, CommunityMessageDto> serverChatKafkaTemplate() {
//        return new KafkaTemplate<>(communityChatProducerFactory());
//    }
//
//}